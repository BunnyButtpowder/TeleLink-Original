...
const DataEditModalForm: FC<Props> = ({customer, isUserLoading}) => {
  ...
  const [userForEdit] = useState<Data>({
    ...customer,
    phoneNum: customer.phoneNum || initialData.phoneNum,
    currentPack: customer.currentPack || initialData.currentPack,
    specialPack: customer.specialPack || initialData.specialPack,
    assignedPack: customer.assignedPack || initialData.assignedPack,
    regisDate: customer.regisDate || initialData.regisDate,
    expDate: customer.expDate || initialData.expDate,
  })
