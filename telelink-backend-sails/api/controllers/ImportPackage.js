...
module.exports = {
    importPackage: async function ( filePath, id) {
        try {
            ...
            if (cleanedWorksheet.length === 0) {
                throw new Error('Không có dữ liệu trong file.');
            }
            ...
            console.log('Import dữ liệu packages thành công.');
            ...
            console.log(err);
            console.log('Lỗi khi import dữ liệu packages:', err.message);
        }
    },
};
